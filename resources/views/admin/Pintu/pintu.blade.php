...
<body>
  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row">
        <div class="col">
          @foreach($data_pintu as $pintu)
          <div class="card shadow">

            
            <div class="card-header border-0">
              
              <h3 class="mb-0">Data pintu {{$pintu->nama_pintu_air}}</h3>
                              ...
                              <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                  ...
                                  <p class="mt-3 mb-0 text-muted text-sm">
                                    ...
                                    <span class="text-nowrap">{{$pintu->nama_penjaga}}</span>
                                  </p>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                  ...
                                  <p class="mt-3 mb-0 text-muted text-sm">
                                    ...
                                    <span class="text-nowrap">{{$pintu->telfon_penjaga}}</span>
                                  </p>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                  ...
                                  <p class="mt-3 mb-0 text-muted text-sm">
                                    ...
                                    <span class="text-nowrap">{{$pintu->alamat_penjaga}}</span>
                                  </p>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                  ...
                                  <p class="mt-3 mb-0 text-muted text-sm">
                                    ...
                                    <span class="text-nowrap">{{$pintu->alamat_pintu_air}}</span>
                                  </p>
                                </div>
                              </div>
                            </div>
                             ...
                             <div class="col-xl-6 col-lg-6">
                               <div class="card card-stats mb-4 mb-xl-0"> 
                                <div class="card-body">
                                  <div class="row">
                                    <div class="col">
                                      <h5 class="card-title text-uppercase text-muted mb-0">Interval Pintu Air </h5>
                                      <p class="mt-3 mb-0 text-muted text-sm">
                                    <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> Aman </span>
                                    <span class="text-nowrap"> <{{$pintu->interval1a}}</span>
                                  </p>
                                  <p class="mt-3 mb-0 text-muted text-sm">
                                    <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> Waspada </span>
                                    <span class="text-nowrap">{{$pintu->interval1a}} - {{$pintu->interval1b}}  </span>
                                  </p>
                                  <p class="mt-3 mb-0 text-muted text-sm">
                                    <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> Kritis </span>
                                    <span class="text-nowrap">{{$pintu->interval2a}} - {{$pintu->interval2b}}</span>
                                  </p>
                                    </div>
                                    <div class="col-auto">
                                      <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                  ...
                                  <p class="mt-3 mb-0 text-muted text-sm">
                                    ...
                                    <span class="text-nowrap"> >{{$pintu->interval2b}} </span>
                                  </p>
                                </div>
                               </div> 
                            </div> 
